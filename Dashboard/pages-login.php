<?php include('Template_Sign/Lheader.php'); ?>
          ...
          <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
            ...
            <div class="card mb-3">
              ...
              <div class="card-body">
                ...
                ?>
                <form action="cek_login.php" class="row g-3 needs-validation" novalidate method="POST">
...
<?php include('Template_Sign/Lfooter.php'); ?>